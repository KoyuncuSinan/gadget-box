          ...
          return(
                  <li className="" key={review._id}>
                      <div className="grid grid-cols-3">
                          <Image src={review.game.image} width={500} height={500} alt="Reviewed game's image" className="col-span-1 w-[6rem] h-[8rem] object-cover" priority></Image>
                          <div className="col-span-2">
                              ...
                              <div className="flex flex-row mt-3 items-center mb-2">
                                  <Image src={review.owner.profilePicture} width={300} height={300} alt="User's profile picture" className="w-[2rem] h-[2rem] rounded-full object-cover" priority></Image>
                                  <Link href={`/user/${review.owner._id}`}>
                                  <span className="ml-2 text-gray-400 font-bold text-lg">{review.owner.username}</span>
                                  </Link>
                                  <span className="text-gray-500 font-light text-xs ml-4">Played at {review.createdAt.slice(0,10)}</span>
                              </div>
